...
#### Os projetos fixados abaixo já estão completos e podem mas não necessariamente precisam de atualizações futuras, já os projetos não fixados podem ou não estar completos.
